...
- العميل يجمع أكثر من منتج في السلة، ثم يكتب بياناته مرة واحدة.
- لوحة الموظف موجودة في `/admin/orders`، وواجهة الدخول في `/admin/login`.
- نقاط العملاء موجودة في `/admin/customers`، والعميل يقدر يعرف رصيده من قسم النقاط في الموقع.
- النقاط تُضاف لطلبات واتساب عند التسليم فقط، ومشتريات المحل تُربط بنفس العميل عن طريق رقم الهاتف.
- دورة الموظف مبسطة إلى «طلب جديد» ثم «تم التسليم»، وحذف الطلب المسلّم يسحب نقاطه تلقائيًا.
